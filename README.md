...
### Slide deck logo
If you would like to display a logo image on every slide, you can do so by setting ```slidedeckLogo``` configuration value to the URL of the image.

```javascript
Reveal.configure({ slidedeckLogo: 'anyURI' });
```
