...
(function( root, factory ) {
	...
	function loadSlide( slide, options ) {
		...
		toArray( slide.querySelectorAll( 'img[data-src], video[data-src], audio[data-src], object[data-src], iframe[data-src]' ) ).forEach( function( element ) {
	...
	function unloadSlide( slide ) {
		...
		toArray( slide.querySelectorAll( 'video[data-lazy-loaded][src], audio[data-lazy-loaded][src], object[data-lazy-loaded][data], iframe[data-lazy-loaded][src]' ) ).forEach( function( element ) {
